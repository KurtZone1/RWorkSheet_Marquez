...
```{r}
data_points <- length(seq1To100)+length(seq20To60)+length(mean20To60)+length(sum51To91)
data_points
```
...
# Describe the output. -It outputs error because the x inside the brackets is not intialized with a value. Also because instead of parentheses they put brackets.
